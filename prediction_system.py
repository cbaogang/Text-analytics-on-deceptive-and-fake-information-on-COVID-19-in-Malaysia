...
loaded_model_LR=pickle.load(open("D:/kylec/Documents/Programming Files/Text-analytics-on-deceptive-and-fake-information-on-COVID-19-in-Malaysia/Fake_news/model/trained_model_LR.sav",'rb'))
loaded_model_DT=pickle.load(open("D:/kylec/Documents/Programming Files/Text-analytics-on-deceptive-and-fake-information-on-COVID-19-in-Malaysia/Fake_news/model/trained_model_DT.sav",'rb'))
loaded_model_RFC=pickle.load(open("D:/kylec/Documents/Programming Files/Text-analytics-on-deceptive-and-fake-information-on-COVID-19-in-Malaysia/Fake_news/model/trained_model_RFC.sav",'rb'))
loaded_model_GBC=pickle.load(open("D:/kylec/Documents/Programming Files/Text-analytics-on-deceptive-and-fake-information-on-COVID-19-in-Malaysia/Fake_news/model/trained_model_GBC.sav",'rb'))
loaded_model_voting=pickle.load(open("D:/kylec/Documents/Programming Files/Text-analytics-on-deceptive-and-fake-information-on-COVID-19-in-Malaysia/Fake_news/model/trained_model_voting.sav",'rb'))
loaded_vectorization = pickle.load(open("D:/kylec/Documents/Programming Files/Text-analytics-on-deceptive-and-fake-information-on-COVID-19-in-Malaysia/Fake_news/model/vectorization.pickle", "rb"))
